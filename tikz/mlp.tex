...
\node[left of=eft,align=left] at (ff1.west) (ff1text) {Linear\\layer};
...
\begin{scope}[shift={(0,-2)}]
	...
	\node[left of=eft,align=left] at (ff2.west) (ff2text) {Linear\\layer};
	...
	\node[block] at ($(prediction.south-|relu) + (0, -0.5)$) (bce) {$\mathrm{BCE}$};
